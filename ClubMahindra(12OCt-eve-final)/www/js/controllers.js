...
.controller('MapCtrl', function($scope, $ionicScrollDelegate, $rootScope) {
    var myBeaAdd = angular.element( document.querySelector( '#beaconMsg' ) );
    myBeaAdd.html("");
  console.log("in map.html");
})

.controller('HomeCtrl', function($scope, $ionicScrollDelegate, $rootScope) {
  //console.log("home");
})
...
.controller('CategoryHotelCtrl', function($scope, $stateParams, $timeout, ionicMaterialMotion, ionicMaterialInk, $ionicHistory) {
